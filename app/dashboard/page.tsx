            ...
            <TabsContent value="overview" className="space-y-4">
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
                <Card className="col-span-4">
                  <CardHeader>
                    <CardTitle>Monthly Order Statistics per Franchise</CardTitle>
                  </CardHeader>
            ...
            <TabsContent value="activity" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>A summary of the most recent actions performed by operators</CardDescription>
                </CardHeader>
                <CardContent>
                  <OperatorActions />
                </CardContent>
